...
export const configAccountsObj = async (
  ...
  const [mintUsdrPubkey, mintUsdrBump] = await PublicKey.findProgramAddress(
    [Buffer.from(constants.MINT_USDR_SEED)],
    programStablePool.programId
  ...
  const accounts: Accounts = {
    ...
    mintUsdr: {
      pubKey: mintUsdrPubkey as PublicKey, // prev: mintUsdKey
      bump: mintUsdrBump as number, // prev: mintUsdNonce
    },
    mintLpSaber,
    vaultLpSaber: {
